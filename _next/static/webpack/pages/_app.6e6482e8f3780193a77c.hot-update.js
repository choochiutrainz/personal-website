...
function Nav() {
  ...
  var getHidden = function getHidden() {
    if (hidden) return 'opacity-0 absolute right-0 fadeIn 2s ease-in forwards';else return '';
  };

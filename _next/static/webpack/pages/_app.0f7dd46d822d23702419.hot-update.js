...
function Header() {
  ...
  var getHeaderBackground = function getHeaderBackground() {
    switch (next_link__WEBPACK_IMPORTED_MODULE_2___default.a.pathname) {
      case "/":
        return 'bg-home';

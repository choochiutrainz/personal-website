...
function Nav() {
  ...
  var transformMenuButtonMiddle = function transformMenuButtonMiddle() {
    if (hidden) return '';else return 'opacity-0 absolute inset-y-50 right-0';
  };

...
function Nav() {
  ...
  var transformMenuButtonTop = function transformMenuButtonTop() {
    if (hidden) return 'transform rotate-45 translate-y-3';else return 'M6 18L18 6M6 6l12 12';
  };

...
function Nav() {
  ...
  var transformMenuButtonTop = function transformMenuButtonTop() {
    if (hidden) return 'transform rotate-45 translate-y-3';else return 'transform -translate-y-3';
  };

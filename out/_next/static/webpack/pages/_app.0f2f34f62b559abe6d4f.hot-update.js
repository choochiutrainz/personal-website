...
function Nav() {
  ...
  var transformMenuButtonTop = function transformMenuButtonTop() {
    if (hidden) return 'transform rotate-45 translate-y-3';else return '';
  };

  var transformMenuButtonBottom = function transformMenuButtonBottom() {
    if (hidden) return 'transform -rotate-45 -translate-y-3';else return 'transform translate-y-1.5';
  };

        ...
        <div className={`h-screen w-screen bg-cover bg-center ${getHeaderBackground()} -my-24 sm:-my-22 mb-1`}>
            ...
            <div className="hidden sm:flex justify-center items-center">
                <a className="absolute bottom-0 pb-4" href="#section1">
                    <button className="focus:outline-none bg-gray-300 text-indigo-600 opacity-80 rounded-full h-12 w-12 flex items-center justify-center transition duration-300 ease-in-out hover:bg-indigo-500 hover:text-gray-300 hover:opacity-75">
